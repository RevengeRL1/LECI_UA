...
```
Entidades: Fornecedor, Produtos e Encomenda

Atributos: 
    Produtos:   Taxa de IVA, Preço, Código, Nome
    Encomenda:  Data de realização, Número da encomenda
    Fornecedor: Código Interno, NIF, Número de Fax, Nome, Condições de Pagamento, Endereço
